...
# Insert new column into the given table
# Update a cell in the table
# Calculate total for a selected column
# Calculate total for a selected row
# Print the whole table or selected rows
# Export the table into a dictionary
#
